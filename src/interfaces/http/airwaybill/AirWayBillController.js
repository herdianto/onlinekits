    ...
    trackbyRajaOngkir(req, res, next) {
        ...
        if (req.query.courier === "anteraja") {
            axios({
                ...
                responseData.waybill = response.data.details.waybill_number;
                responseData.courier = req.query.courier;
                responseData.isDelivered = response.data.details.receiver_name === ""? false : true;
                responseData.jenisPaket = response.data.details.service_code;
                responseData.tanggalResi = response.data.details.waybill_time;
                responseData.namaPengirim = response.data.details.shippper_name;
                responseData.namaPenerima = response.data.details.receiver_name;
                responseData.namaPenerimaAktual = response.data.details.receiver_name;
                responseData.alamatAsal = response.data.details.shipper_city;
                responseData.alamatTujuan = response.data.details.receiver_city;
                responseData.tglTerima = "";
                responseData.waktuTerima = "";
                responseData.tglKirim = "";
                responseData.waktuKirim = "";
